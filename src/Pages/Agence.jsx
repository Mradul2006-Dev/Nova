  ...
  const teamMembers = [
    {
      ...
      img: "/Images/team_Images/1.jpg",
    },
    {
      name: "Camille",
      title: "Directrice Artistique",
      img: "/Images/team_Images/2.jpg",
    },
    ...
    {
      name: "Mylene",
      title: "Directrice de création",
      img: "/Images/team_Images/6.jpg",
    },
    {
      name: "Meggie",
      title: "Directrice conseil",
      img: "/Images/team_Images/7.jpg",
    },
  ...
  useGSAP(() => {
    ...
    gsap.to(imageDivRef.current, {
      scrollTrigger: {
        ...
        start: isMobile ? "top 15%" : "top 26.15%",
        end: isMobile ? "top -80%" : "top -130%",
        pin: true,
        pinSpacing: true,
        // pinReparent: true,
        pinType: "transform",
  ...
  return (
    <div>
      ...
      <div className="section1 relative py-1">
        <div
          ref={imageDivRef}
          className="absolute overflow-hidden lg:h-[20vw] h-[40vw] lg:w-[15vw] w-[35vw] lg:rounded-3xl rounded-2xl left-[30vw]"
          style={{ top: isMobile ? "15vh" : "20vh" }}
        >
          <img
...
//     const preload = imageArray.map((src) => {
...
//     const setup = () => {
//       pinTrigger = gsap.to(imageDivRef.current, {
//         scrollTrigger: {
//           trigger: imageDivRef.current,
//           start: isMobile ? "top 15%" : "top 24%",
//           end: isMobile ? "top -80%" : "top -130%",
//           pin: true,
//           pinSpacing: true,
//           pinType: "transform",
...
//       transitionTrigger = gsap.to(".transition-section", {
//         backgroundColor: "#000000",
//         color: "#ffffff",
//         scrollTrigger: {
//           trigger: ".transition-section",
...
//     // Wait until BOTH fonts and images have finished loading before
//     // creating the ScrollTrigger at all. Initializing it earlier (even
//     // if we refresh afterwards) measures positions against an unstable
//     // layout, and the later refresh snaps things into place visibly.
//     // Waiting first means there's only ever one, correct calculation.
//     const fontsReady = document.fonts ? document.fonts.ready : Promise.resolve();

//     Promise.all([fontsReady, ...preload]).then(() => {
//       setup();
//     });
...
//           ref={imageDivRef}
//           className="absolute overflow-hidden lg:h-[20vw] h-[40vw] lg:w-[15vw] w-[35vw] lg:rounded-3xl rounded-2xl left-[30vw]"
//           style={{ top: window.innerWidth < 1024 ? "15vh" : "20vh" }}
//         >
//           <img
//             className="h-full w-full object-cover"
//             ref={imageRef}
...
//         </div>
//         <div className="relative font-[font-2]">
//           <div className="lg:mt-[50vh] mt-[40vh]">
//             <h1 className="text-[20vw] text-center uppercase leading-[18vw]">
//               Soixan7e <br />
//               Douze
//             </h1>
